...
document.getElementById("generate-report").addEventListener("click", () => {
    ...
    try {
        ...
        const addHeader = () => {
            ...
            doc.text("Environmental Consultancy Company", margin, 10);
            doc.setFontSize(12);
        ...
        yOffset += 20;
        doc.setFontSize(18);
        doc.text("Produced by Environmental Consultancy Company", margin, yOffset);
        yOffset += 20;
        doc.addPage();
        ...
        const contents = [
            ...
            "Stakeholder Involvement Tracker",
...
addPage();
    ...
    // Stakeholder Involvement Tracker
    addSectionTitle("Stakeholder Involvement Tracker");
    stakeholders.forEach(stakeholder => {
        addSubHeadingAndText("Role", stakeholder.role);
        addSubHeadingAndText("Status", stakeholder.status);
        addSubHeadingAndText("Email", stakeholder.email || "N/A");
        addSubHeadingAndText("Phone", stakeholder.phone || "N/A");
        addSubHeadingAndText("Comments", stakeholder.comments || "None");
    });
    addPage();

    // Policy Compliance Checklist
    addSectionTitle("Policy Compliance Checklist");
    const checklistContainer = document.getElementById("policy-compliance-checklist");
    if (checklistContainer) {
        const checklistHTML = checklistContainer.innerHTML;
        const checklistText = checklistHTML.replace(/<[^>]*>?/gm, ''); // Remove HTML tags
        addSubHeadingAndText("Policy Compliance Checklist", checklistText);
    }
    addPage();
